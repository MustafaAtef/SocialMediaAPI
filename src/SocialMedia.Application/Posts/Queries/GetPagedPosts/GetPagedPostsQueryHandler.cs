...
public sealed class GetPagedPostsQueryHandler(ISqlConnectionFactory sqlConnectionFactory)
    : IQueryHandler<GetPagedPostsQuery, PagedList<PostResponse>>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        using var multi = await connection.QueryMultipleAsync(sql, new { request.UserId, Offset = (request.Page - 1) * request.PageSize, request.PageSize });
