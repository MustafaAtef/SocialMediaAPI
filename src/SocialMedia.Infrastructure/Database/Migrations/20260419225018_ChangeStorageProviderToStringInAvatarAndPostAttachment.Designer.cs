...
namespace SocialMedia.Infrastructure.Database.Migrations
{
    ...
    [Migration("20260419225018_ChangeStorageProviderToStringInAvatarAndPostAttachment")]
    partial class ChangeStorageProviderToStringInAvatarAndPostAttachment
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SocialMedia.Infrastructure.Outbox.EmailOutboxMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ProcessedOn", "CreatedAt")
                        .HasFilter("[ProcessedOn] IS NULL");

                    b.ToTable("EmailOutboxMessages");
                });

            modelBuilder.Entity("SocialMedia.Infrastructure.Outbox.OutboxMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
